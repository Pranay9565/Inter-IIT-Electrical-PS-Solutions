...
|----------|-------------|-------|---------------------|--------------------|-----------------|---------------------|
| **PWM** | 1 | Can be set to any frequency depending on hardware  |  | 1 transmitter → 1 receiver | Low (analog duty-cycle, sensitive to noise) | A PWM-capable timer/output pin on sender; a PWM-capable input/capture pin or filter+ADC on receiver |
